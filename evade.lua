-- ========== KONFIGURASI ==========
local ANOLIB_RAW_URL = "https://raw.githubusercontent.com/Anonymous9x-oss/Anonymous9xProjectv1/refs/heads/main/anolib.lua"  -- GANTI DENGAN URL RAW ANDA
-- =================================

-- Load library dari raw URL (persis seperti Blox Fruit)
local bearlib
local success, err = pcall(function()
    bearlib = loadstring(game:HttpGet(ANOLIB_RAW_URL))()
end)

if not success or not bearlib then
    error("Gagal memuat anolib dari raw URL:\n" .. tostring(err) .. "\nPeriksa koneksi atau URL.")
end

-- ==================== EVADE SCRIPT (dengan bearlib dari raw) ====================
...
-- Variabel (sama seperti versi sebelumnya)
local ValueSpeed = 16
...
-- Helper functions (sama persis seperti script sebelumnya, tidak diubah)
...
print("Evade script loaded — UI library diambil dari raw URL")
